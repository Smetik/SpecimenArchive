...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-(!apaklj038)qx@cyrlle_p3q3qplsw*d0rt2oz5q@zlr28%t)')
...
default_sqlite_path = '/app/data/db.sqlite3' if IN_DOCKER else str(BASE_DIR / 'db.sqlite3')
